...
plot(p, y, type = 'l', main = expression('b'[3]), xlab = 'x', ylab = expression('b'[3]*'(x)'), lwd = lwd_my)

y <- c()
for(i in 1:1001){
  y[i] <- gg[[2]](p[i])
}
plot(p, y, type = 'l', main = expression('h'[1]), xlab = 'x', ylab = expression('h'[1]*'(x)'), lwd = lwd_my)

y <- c()
for(i in 1:1001){
  y[i] <- gg[[3]](p[i])
}
plot(p, y, type = 'l', main = expression('b'[1]), xlab = 'x', ylab = expression('b'[1]*'(x)'), lwd = lwd_my)

y <- c()
for(i in 1:1001){
  y[i] <- gg[[4]](p[i])
}
plot(p, y, type = 'l', main = expression('h'['c']), xlab = 'x', ylab = expression('h'['c']*'(x)'), lwd = lwd_my)

y <- c()
for(i in 1:1001){
  y[i] <- gg[[5]](p[i])
}
plot(p, y, type = 'l', main = expression('b'[5]), xlab = 'x', ylab = expression('b'[5]*'(x)'), lwd = lwd_my)

y <- c()
for(i in 1:1001){
  y[i] <- gg[[6]](p[i])
}
plot(p, y, type = 'l', main = expression('b'[7]), xlab = 'x', ylab = expression('b'[7]*'(x)'), lwd = lwd_my)
